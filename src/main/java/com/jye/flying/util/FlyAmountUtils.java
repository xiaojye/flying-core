 ...
 */
public final class FlyAmountUtils {

    private FlyAmountUtils() {
    ...
    public static String stripTrailingZeros(long val) {
        return FlyBigDecimalUtils.stripTrailingZeros(val);
    }
        ...
        while (true) {
            ...
            switch (inputOption) {
                case "1":
                    ...
                    if (input1.contains(",")) {
                        System.out.println(FlyAmountUtils.format(input1.split(",")[0], Integer.parseInt(input1.split(",")[1])));
                    } else {
                        System.out.println(FlyAmountUtils.format(input1));
                    }
                    break;
                case "2":
                    System.out.println("请输入金额 ：");
                    String input2 = scanner.next();
                    System.out.println(FlyAmountUtils.changeY2F(input2));
                    break;
                case "3":
                    System.out.println("请输入金额（设置精度0.00,2表示保留两位小数）：");
                    String input3 = scanner.next();
                    if (input3.contains(",")) {
                        System.out.println(FlyAmountUtils.changeF2Y(input3.split(",")[0], Integer.parseInt(input3.split(",")[1])));
                    } else {
                        System.out.println(FlyAmountUtils.changeF2Y(input3));
                    }
                    break;
                case "4":
                    System.out.println("请输入金额 ：");
                    String input4 = scanner.next();
                    System.out.println(FlyAmountUtils.stripTrailingZeros(input4));
                    break;
                default:
