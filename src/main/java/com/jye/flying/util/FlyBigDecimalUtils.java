 ...
 */
public class FlyBigDecimalUtils {
     ...
     * @return 格式化后的字符串
     */
    public static String format(BigDecimal val, int digit) {
        return format(val.toPlainString(), digit);
    }
     ...
     * @return 格式化后的字符串
     */
    public static String format(String val, int digit) {
    ...
    public static BigDecimal add(String arg1, String arg2) {
        if (!FlyCheckUtils.checkNumber(arg1)) {
            arg1 = "0.0";
        }
        if (!FlyCheckUtils.checkNumber(arg2)) {
            arg2 = "0.0";
        }
