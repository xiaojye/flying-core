 ...
 */
public final class FlyDeviceUtils {
    private static final String TAG = FlyDeviceUtils.class.getSimpleName();
    ...
    static {
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.O) {
            ...
            try {
                ...
                e.printStackTrace();
                FlyLogger.e(TAG, "read file error", e);
            } finally {
                FlyStreamUtils.close(fileInputStream);
            }
        }
        ...
        try {
            ...
            FlyLogger.e(TAG, "read SystemProperties error", e);
        }
    }

    private FlyDeviceUtils() {
